...
#define ICM42605_ADDRESS (0x68 << 1)  // Address of ICM42605 accel/gyro
...
class ICM42605 {
 public:
  ICM42605(I2C_HandleTypeDef* i2c_bus);
 ...
 private:
  ...
  void readBytes(uint16_t address, uint16_t size, uint8_t* data);
